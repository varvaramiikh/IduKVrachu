...
async def start_handler(message: types.Message):
    ...
    if user.consent_timestamp:
        await message.answer(
            ...
            "Рады снова видеть вас в сервисе «Иду к врачу» 🏥\n\n"
            "<b>Что доступно в главном меню:</b>\n"
            "• 📚 Подготовка к посещению врача — мультфильмы, "
            "социстории и игры-тренажёры\n"
            "• 📅 Запись к специалисту в удобной клинике\n"
